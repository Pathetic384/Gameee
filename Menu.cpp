...
int Menu::CreateLevels(SDL_Renderer* screen, int& score, int& score2, int& score3, int& score4)
{
...
int Menu::CreateResult(SDL_Renderer* screen, int& score, int& high_score)
{
    Base menu;
