...
int main(int argc, char* argv[])
{
    ...
    while (action != 3)
    {
        ...
        {
            Mix_HaltMusic();
            action = menuing.CreateLevels(g_screen, high_score, high_score2, high_score3, high_score4);
        }
        ...
        if (action == 5)
        {
            action = menuing.CreateResult(g_screen, score, high_score);
        }
        ...
        if (action == 11)
        {
            action = menuing.CreateResult(g_screen, score2, high_score2);
        }
        if (action == 12)
        {
            action = menuing.CreateResult(g_screen, score3, high_score3);
        }
        if (action == 13)
        {
            action = menuing.CreateResult(g_screen, score4, high_score4);
        }
    }
     close();
     return 0;
