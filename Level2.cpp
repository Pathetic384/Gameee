...
int Level2::CreateLevel(SDL_Renderer* screen, int& score)
{
    ...
    while (is_quit == false)
    {
        ...
        if (mode == 1)
        {
            if (m1 == 0)
            {
                layer11.LoadImg("img//bk2//1.png", screen);       layer12.LoadImg("img//bk2//1.png", screen);
                layer21.LoadImg("img//bk2//2.png", screen);       layer22.LoadImg("img//bk2//2.png", screen);
                layer31.LoadImg("img//bk2//3.png", screen);       layer32.LoadImg("img//bk2//3.png", screen);
                layer41.LoadImg("img//bk2//4.png", screen);       layer42.LoadImg("img//bk2//4.png", screen);
                layer51.LoadImg("img//bk2//5.png", screen);       layer52.LoadImg("img//bk2//5.png", screen);
                layer61.LoadImg("img//bk2//6.png", screen);       layer62.LoadImg("img//bk2//6.png", screen);
            }
            m1 = 1;
            m2 = 0;
            m3 = 0;
        ...
        if (mode == 2)
        {
            if (m2 == 0)
            {
                layer11.LoadImg("img//bk2//2//1.png", screen);       layer12.LoadImg("img//bk2//2//1.png", screen);
                layer21.LoadImg("img//bk2//2//2.png", screen);       layer22.LoadImg("img//bk2//2//2.png", screen);
                layer31.LoadImg("img//bk2//2//3.png", screen);       layer32.LoadImg("img//bk2//2//3.png", screen);
                layer41.LoadImg("img//bk2//2//4.png", screen);       layer42.LoadImg("img//bk2//2//4.png", screen);
                layer51.LoadImg("img//bk2//2//4.png", screen);       layer52.LoadImg("img//bk2//2//4.png", screen);
                layer61.LoadImg("img//bk1//2//4.png", screen);       layer62.LoadImg("img//bk2//2//4.png", screen);
            }
            m1 = 0;
            m2 = 1;
            m3 = 0;
        ...
        if (mode == 3)
        {
            if (m3 == 0)
            {
                layer11.LoadImg("img//bk2//3//1.png", screen);       layer12.LoadImg("img//bk2//3//1.png", screen);
                layer21.LoadImg("img//bk2//3//2.png", screen);       layer22.LoadImg("img//bk2//3//2.png", screen);
                layer31.LoadImg("img//bk2//3//3.png", screen);       layer32.LoadImg("img//bk2//3//3.png", screen);
                layer41.LoadImg("img//bk2//3//4.png", screen);       layer42.LoadImg("img//bk2//3//4.png", screen);
                layer51.LoadImg("img//bk2//3//4.png", screen);       layer52.LoadImg("img//bk2//3//4.png", screen);
                layer61.LoadImg("img//bk2//3//4.png", screen);       layer62.LoadImg("img//bk2//3//4.png", screen);
            }
            m3 = 0;
            m2 = 0;
            m3 = 1;
