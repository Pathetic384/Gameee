...
int Level3::CreateLevel(SDL_Renderer* screen, int& score)
{
    ...
    Base layer11;
    layer11.LoadImg("img//bk3//1.png", screen);
    Base layer12;
    layer12.LoadImg("img//bk3//1.png", screen);
    layer12.SetRect(1200, 0);
    Base layer21;
    layer21.LoadImg("img//bk3//2.png", screen);
    Base layer22;
    layer22.LoadImg("img//bk3//2.png", screen);
    layer22.SetRect(1200, 0);
    Base layer31;
    layer31.LoadImg("img//bk3//3.png", screen);
    Base layer32;
    layer32.LoadImg("img//bk3//3.png", screen);
    layer32.SetRect(1200, 0);
    Base layer41;
    layer41.LoadImg("img//bk3//4.png", screen);
    Base layer42;
    layer42.LoadImg("img//bk3//4.png", screen);
    layer42.SetRect(1200, 0);
    Base layer51;
    layer51.LoadImg("img//bk3//5.png", screen);
    Base layer52;
    layer52.LoadImg("img//bk3//5.png", screen);
    ...
    Mix_Music* mus3;
    mus3 = Mix_LoadMUS("songs//Jojo.mp3");
