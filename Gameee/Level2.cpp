...
int Level2::CreateLevel(SDL_Renderer* screen, int& high_score, int sprite, int& percentage)
{
    ...
    Mix_Music* mus;
    mus = Mix_LoadMUS("songs//Cupid.mp3");
    Mix_PlayMusic(mus, 1);
    Mix_PauseMusic();
    ...
    while (is_quit == false)
    {
        ...
        {
            std::string re2 = std::to_string(percent + 1);
            re2 += '%';
            perc.SetText(re2);
        }
